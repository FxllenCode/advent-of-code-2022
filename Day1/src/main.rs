...
fn main() -> io::Result<()> {
    ...
    println!(
        "Elf number {} has the most calories with {}!",
        largest_tuple.0, largest_tuple.1
    );
    ...
    println!(
        "Elf number {} has the second most calories with {}!",
        second_largest.0, second_largest.1
    );
    ...
    println!(
        "Elf number {} has the third most calories with {}!",
        third_largest.0, third_largest.1
    );
    println!(
        "The top three elves have {} calories total!",
        largest_tuple.1 + second_largest.1 + third_largest.1
    );
    Ok(())
}
